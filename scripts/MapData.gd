...
static func _cooling() -> Dictionary:
	return {
		...
		"platforms": [
			...
			# 정상 — 비균질 섞기 (1-2-1-2 규칙 깸).
			{"pos": Vector2(640, 960),  "w": 240.0},  # 80 (1)
			{"pos": Vector2(560, 820),  "w": 240.0},  # 140 (2)
			{"pos": Vector2(620, 720),  "w": 240.0},  # 100 (1 빠듯)
			{"pos": Vector2(580, 640),  "w": 240.0},  # 80 (1) — 1-1 연속
			{"pos": Vector2(640, 500),  "w": 240.0},  # 140 (2)
			{"pos": Vector2(560, 400),  "w": 240.0},  # 100 (1 빠듯)
			{"pos": Vector2(620, 280),  "w": 320.0},  # 120 (1 빠듯) — 골 직전
		],
		"enemies": {
