...
static func _rooftops() -> Dictionary:
	return {
		...
		"platforms": [
			...
			# 정상 — 1/2칸 섞기, 8 발판 (1280 → 280)
			{"pos": Vector2(640, 1180), "w": 240.0},  # 100
			{"pos": Vector2(560, 1040), "w": 240.0},  # 140 (2)
			{"pos": Vector2(640, 960),  "w": 240.0},  # 80
			{"pos": Vector2(560, 820),  "w": 240.0},  # 140 (2)
			{"pos": Vector2(640, 740),  "w": 240.0},  # 80
			{"pos": Vector2(560, 600),  "w": 240.0},  # 140 (2)
			{"pos": Vector2(640, 520),  "w": 240.0},  # 80
			{"pos": Vector2(560, 380),  "w": 240.0},  # 140 (2)
			{"pos": Vector2(640, 280),  "w": 320.0},  # 100 — 골 직전
		],
		"enemies": {
...
static func _cooling() -> Dictionary:
	return {
		...
		"camera_mode":  "VERTICAL",
		"platforms": [
			# 지상(3080) → 분기점 1880 — 1/2칸 섞은 지그재그
			{"pos": Vector2(640, 3000), "w": 280.0},  # 80
			{"pos": Vector2(540, 2920), "w": 280.0},  # 80
			{"pos": Vector2(640, 2780), "w": 280.0},  # 140 (2)
			{"pos": Vector2(540, 2700), "w": 280.0},  # 80 — patrol 자리
			{"pos": Vector2(640, 2560), "w": 280.0},  # 140 (2)
			{"pos": Vector2(540, 2480), "w": 280.0},  # 80
			{"pos": Vector2(640, 2340), "w": 280.0},  # 140 (2) — patrol 자리
			{"pos": Vector2(540, 2260), "w": 280.0},  # 80
			{"pos": Vector2(640, 2120), "w": 280.0},  # 140 (2)
			{"pos": Vector2(540, 2040), "w": 280.0},  # 80
			{"pos": Vector2(640, 1900), "w": 320.0},  # 140 (2)
			{"pos": Vector2(540, 1820), "w": 320.0},  # 80 — 분기점, patrol 자리
			# 분기 — 우측 파이프 (드론 perch + XP)
			{"pos": Vector2(900, 1680), "w": 200.0},  # 140 (2 진입)
			{"pos": Vector2(960, 1600), "w": 180.0},  # 80
			{"pos": Vector2(900, 1460), "w": 200.0},  # 140 (2)
			{"pos": Vector2(960, 1380), "w": 200.0},  # 80
			{"pos": Vector2(900, 1240), "w": 220.0},  # 140 (2)
			{"pos": Vector2(960, 1160), "w": 220.0},  # 80 — 우측 끝 (XP)
			# 분기 — 좌측 계단 (HP)
			{"pos": Vector2(220, 1680), "w": 200.0},  # 140 (2 진입)
			{"pos": Vector2(160, 1600), "w": 200.0},  # 80
			{"pos": Vector2(220, 1460), "w": 200.0},  # 140 (2)
			{"pos": Vector2(160, 1380), "w": 200.0},  # 80
			{"pos": Vector2(220, 1240), "w": 200.0},  # 140 (2)
			{"pos": Vector2(180, 1160), "w": 220.0},  # 80 — 좌측 끝 (HP)
			# 합류 도약 — 1040 (120 빠듯)
			{"pos": Vector2(540, 1040), "w": 320.0},  # 합류
			# 정상 — 1/2칸 섞기 (1040 → 280)
			{"pos": Vector2(640, 940),  "w": 240.0},  # 100
			{"pos": Vector2(540, 800),  "w": 240.0},  # 140 (2)
			{"pos": Vector2(640, 720),  "w": 240.0},  # 80
			{"pos": Vector2(540, 580),  "w": 240.0},  # 140 (2)
			{"pos": Vector2(640, 500),  "w": 240.0},  # 80
			{"pos": Vector2(540, 360),  "w": 240.0},  # 140 (2)
			{"pos": Vector2(640, 280),  "w": 320.0},  # 80 — 골 직전
		],
		"enemies": {
		...
		"rewards": {
			"xp_orbs":    [Vector2(960, 1130.0), Vector2(1000, 1130.0)],
			"hp_pickups": [Vector2(180, 1130.0)],
		},
		"spikes": [],
	}
...
static func _watchtower() -> Dictionary:
	return {
		...
		"platforms": [
			...
			# 정상 — 1/2칸 섞기 (1700 → 280)
			{"pos": Vector2(640, 1620), "w": 240.0},  # 80
			{"pos": Vector2(560, 1480), "w": 240.0},  # 140 (2)
			{"pos": Vector2(640, 1400), "w": 240.0},  # 80
			{"pos": Vector2(560, 1260), "w": 240.0},  # 140 (2)
			{"pos": Vector2(640, 1180), "w": 240.0},  # 80
			{"pos": Vector2(560, 1040), "w": 240.0},  # 140 (2)
			{"pos": Vector2(640, 960),  "w": 240.0},  # 80
			{"pos": Vector2(560, 820),  "w": 240.0},  # 140 (2)
			{"pos": Vector2(640, 740),  "w": 240.0},  # 80
