...
static func _sewers() -> Dictionary:
	return {
		...
		# 우측 파이프 가시 — 폭 70 가시 좌/우 한 쌍 + 양 사이에 가운데 단일 가시
		# 추가. 좌(875~945)/우(975~1045) 사이 30px 통로 + 가운데(945~975) 가시
		# 어긋난 위치로 강제. 정밀한 회피 없이는 닿게.
		"spikes": [
			# 800 ↔ 960 사이
			{"x": 910.0, "y": 880.0, "w": 70.0},
			{"x": 1010.0, "y": 880.0, "w": 70.0},
			{"x": 960.0, "y": 920.0, "w": 30.0},
			# 960 ↔ 1120 사이
			{"x": 910.0, "y": 1040.0, "w": 70.0},
			{"x": 1010.0, "y": 1040.0, "w": 70.0},
			{"x": 960.0, "y": 1080.0, "w": 30.0},
			# 1120 ↔ 1280 사이
			{"x": 910.0, "y": 1200.0, "w": 70.0},
			{"x": 1010.0, "y": 1200.0, "w": 70.0},
			{"x": 960.0, "y": 1240.0, "w": 30.0},
		],
	}
