...
const STORY_BRIEFINGS: Array = [
	# stage 0 — 외곽 진입 (ACT1 또렷 · "시야=신뢰" 모티프 심기)
	[
		"외곽부터 가요. 길은 제가 봐요.",
		"첫 임무예요, 요원. 제가 봐줄게요.",
	],
	...
	# stage 2 — 격리 / 봉인 (ACT2 균열 · 첫 멈칫)
	[
		"이 구역은 오래됐어요. 오래 닫혀 있었고요.",
		"저 문 너머는... 잠깐. 아니에요. 가던 길 가요.",
	],
	# stage 3 — 핵심부 보스 (ACT3 두려움 · 시야 얇음)
	[
		"이상하죠. 다 와서 더 안 보여요.",
		"끝까지 같이 가요. 제가 보는 한.",
	],
...
const BRIEFINGS: Array = [
	...
	# stage 2 — ACT2 직전 · 첫 멈칫(봉인 구역) · VEIL 판단 틀림 인정
	[
		"중간이에요. 저격수 자리가 늘어요. 시야 끊기는 곳 골라요.",
	...
	# stage 4 — ACT2 후반 · 차폐 시작(시야가 늦어짐) · 임무 외 질문
	[
		"여기서부터 제 시야가 늦어요. 머리 위는 직접 봐줘요.",
		"잠깐... 아니에요. 보여요. 가요.",
		"이 임무 의뢰인이 누군지 알아요? 저도 몰라요.",
	],
