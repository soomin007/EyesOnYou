...
const BRIEFINGS: Array = [
	...
	# stage 3 — ACT 2 (심층 진입, 격리 병동 / 잠긴 문 복선)
	[
		"이 층은 도면이랑 달라요. 조심해요.",
		"여기 어디 잠긴 문이 있을 거예요. 신경 쓰지 말아요.",
		"이 구역은 오래됐어요. 누가 봉인한 건지 저도 몰라요.",
	],
	# stage 4 — ACT 2 (VEIL 임무 외 질문 — 드론은 stage 3 cooling에서도 등장 가능해 라인 일반화)
	[
		"위에서 오는 것들 조심해요. 머리 위 자주 봐요.",
		"핵심부 가까워요. 여기서부터 달라요.",
		"요원, 이 임무 의뢰인이 누군지 알아요? 저도 몰라요. 그냥 궁금했어요.",
	],
	# stage 5 — ACT 2→3 전환 (핵심부 접근, ??? 등장)
	[
		"서버실 바로 위층이에요. 마지막 갈림길이에요.",
